...
class TripDetailViewController: UIViewController, MKMapViewDelegate {
    ...
    */
    ...
    func sharePressed(sender: UIButton!) {
        let string: String = "Check out my recent drive!"
        let url: URL = URL(string: "http://www.audiusa.com")!
        
        let activityViewController = UIActivityViewController(activityItems: [string, url, #imageLiteral(resourceName: "route")], applicationActivities: nil)
    ...
    private func prepareToolbar() {
        ...
        toolbar.title = self.trip_snapshot.key
